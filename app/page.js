...
export default function Home() {
  useGSAP(() => {
    ...
    document.fonts.ready.then(() => {
      let splitIntro = SplitText.create(".intro", { type: "words" });
      let splitHeading = SplitText.create(".heading");
      let splitDesc = SplitText.create(".description", {
        type: "lines",
        autoSplit: true,
        onSplit: (self) => {
      ...
      <main className="min-h-screen flex flex-col lg:justify-end py-6 md:py-24 px-6 md:px-10 xl:px-32">
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between gap-12 px-0 md:px-12 text-center lg:text-left">
          ...
          <div className="flex flex-col gap-6">
            <p className="split intro uppercase barlow-condensed text-base md:text-[28px] tracking-[4px]">
              So, You Want to Travel To
            </p>
            <h1 className="split heading intro-heading bellefair text-center lg:text-left text-white text-[80px] md:text-[144px] leading-none">
              SPACE
            </h1>
            <p className="split description max-w-xl barlow font-light text-base leading-[180%]">
